...
func (c *orderServiceClient) DeleteOrder(ctx context.Context, in *OrderByIdRequest, opts ...grpc.CallOption) (*OrderResponse, error) {
	out := new(OrderResponse)
...
func (c *orderServiceClient) GetOrderById(ctx context.Context, in *OrderByIdRequest, opts ...grpc.CallOption) (*OrderResponse, error) {
	out := new(OrderResponse)
...
func (UnimplementedOrderServiceServer) DeleteOrder(context.Context, *OrderByIdRequest) (*OrderResponse, error) {
...
func _OrderService_DeleteOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).DeleteOrder(ctx, req.(*OrderByIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
